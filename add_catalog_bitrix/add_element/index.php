...
<div class="container">
    <div class="row">
        <div class="prerol сol">
            <div class="alert alert-danger" role="alert">Добавление элементов <div class="result-total"></div></div>
        </div>
    </div>
    <div class="row">
                    ...
                    var request = function(id){
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                $('.page-body').prepend('<div class="alert alert-success" role="alert">"Элемент добавлен"'+data.message+': '+data.price+'</div>').slideDown("slow");
